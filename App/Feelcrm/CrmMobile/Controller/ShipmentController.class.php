...
class ShipmentController extends BasicController
{
	...
	public function checkCreate()
	{
		...
		$ShipmentCheckForm = D('CrmDefineForm')->CheckForm($this->_company_id,$shipment_form,'shipment',$this->_mobile);
	...
	public function checkEdit($shipment_id,$customer_id)
	{
		...
		$ShipmentCheckForm = D('CrmDefineForm')->CheckForm($this->_company_id,$shipment_form,'shipment',$this->_mobile,$shipment_id);
