...
class Gd{
    ...
    public function save($imgname, $type = null, $quality=80,$interlace = true)
	{
		...
		else if('gif' == $type && !empty($this->gif))
		{
     ...
     */
    public function thumb($width, $height, $type = Image::IMAGE_THUMB_SCALE,$logo){
        ...
        switch ($type) 
		{
            ...
            case Image::IMAGE_THUMB_FILLED:
                ...
                do{
					...
					if($logo)
					{
						imagealphablending($img, false);//取消默认的混色模式（为解决阴影为绿色的问题）  

						imagesavealpha($img,true);//设定保存完整的 alpha 通道信息

						// 调整默认颜色
						$color = imagecolorallocatealpha($img,255,255,255,127);//127 为透明值0-127，0不透明
